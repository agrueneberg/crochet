...
test_that("maximum dimension requirement are met", {
    ...
    expect_lt(nrow(TST_A), OUT_OF_BOUNDS)
    expect_lt(ncol(TST_A), OUT_OF_BOUNDS)
    expect_lt(prod(dim(TST_A)), OUT_OF_BOUNDS)
...
test_that("single indexing by positive integers works", {
    ...
    expect_equal(TST_A[OUT_OF_BOUNDS], TST_B[OUT_OF_BOUNDS])
    expect_equal(TST_A[OUT_OF_BOUNDS, drop = TRUE], TST_B[OUT_OF_BOUNDS, drop = TRUE])
    expect_equal(TST_A[OUT_OF_BOUNDS, drop = FALSE], TST_B[OUT_OF_BOUNDS, drop = FALSE])

    expect_equal(TST_A[c(OUT_OF_BOUNDS, 2)], TST_B[c(OUT_OF_BOUNDS, 2)])
    expect_equal(TST_A[c(OUT_OF_BOUNDS, 2), drop = TRUE], TST_B[c(OUT_OF_BOUNDS, 2), drop = TRUE])
    expect_equal(TST_A[c(OUT_OF_BOUNDS, 2), drop = FALSE], TST_B[c(OUT_OF_BOUNDS, 2), drop = FALSE])

    expect_equal(TST_A[c(2, OUT_OF_BOUNDS)], TST_B[c(2, OUT_OF_BOUNDS)])
    ...
    m <- matrix(data = c(OUT_OF_BOUNDS, OUT_OF_BOUNDS), ncol = 2, byrow = TRUE)
...
test_that("single indexing by logicals works", {
    ...
    expect_equal(TST_A[rep_len(TRUE, OUT_OF_BOUNDS)], TST_B[rep_len(TRUE, OUT_OF_BOUNDS)])
    expect_equal(TST_A[rep_len(TRUE, OUT_OF_BOUNDS), drop = rep_len(TRUE, OUT_OF_BOUNDS)], TST_B[rep_len(TRUE, OUT_OF_BOUNDS), drop = rep_len(TRUE, OUT_OF_BOUNDS)])
    expect_equal(TST_A[rep_len(TRUE, OUT_OF_BOUNDS), drop = FALSE], TST_B[rep_len(TRUE, OUT_OF_BOUNDS), drop = FALSE])

    expect_equal(TST_A[rep_len(FALSE, OUT_OF_BOUNDS)], TST_B[rep_len(FALSE, OUT_OF_BOUNDS)])
    expect_equal(TST_A[rep_len(FALSE, OUT_OF_BOUNDS), drop = rep_len(FALSE, OUT_OF_BOUNDS)], TST_B[rep_len(FALSE, OUT_OF_BOUNDS), drop = rep_len(FALSE, OUT_OF_BOUNDS)])
    expect_equal(TST_A[rep_len(FALSE, OUT_OF_BOUNDS), drop = rep_len(FALSE, OUT_OF_BOUNDS)], TST_B[rep_len(FALSE, OUT_OF_BOUNDS), drop = rep_len(FALSE, OUT_OF_BOUNDS)])

    expect_equal(TST_A[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS)], TST_B[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS)])
    expect_equal(TST_A[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), drop = TRUE], TST_B[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), drop = TRUE])
    expect_equal(TST_A[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), drop = FALSE], TST_B[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), drop = FALSE])

    expect_equal(TST_A[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS)], TST_B[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS)])
    expect_equal(TST_A[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), drop = TRUE], TST_B[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), drop = TRUE])
    expect_equal(TST_A[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), drop = FALSE], TST_B[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), drop = FALSE])
...
test_that("multi indexing by positive integers works", {
    ...
    expect_error(TST_A[OUT_OF_BOUNDS, ])
    expect_error(TST_B[OUT_OF_BOUNDS, ])
    expect_error(TST_A[OUT_OF_BOUNDS, , drop = TRUE])
    expect_error(TST_B[OUT_OF_BOUNDS, , drop = TRUE])
    expect_error(TST_A[OUT_OF_BOUNDS, , drop = FALSE])
    expect_error(TST_B[OUT_OF_BOUNDS, , drop = FALSE])
    ...
    expect_error(TST_A[OUT_OF_BOUNDS, OUT_OF_BOUNDS])
    expect_error(TST_B[OUT_OF_BOUNDS, OUT_OF_BOUNDS])
    expect_error(TST_A[OUT_OF_BOUNDS, OUT_OF_BOUNDS, drop = TRUE])
    expect_error(TST_B[OUT_OF_BOUNDS, OUT_OF_BOUNDS, drop = TRUE])
    expect_error(TST_A[OUT_OF_BOUNDS, OUT_OF_BOUNDS, drop = FALSE])
    expect_error(TST_B[OUT_OF_BOUNDS, OUT_OF_BOUNDS, drop = FALSE])

    expect_error(TST_A[c(OUT_OF_BOUNDS, 2), ])
    expect_error(TST_B[c(OUT_OF_BOUNDS, 2), ])
    expect_error(TST_A[c(OUT_OF_BOUNDS, 2), , drop = TRUE])
    expect_error(TST_B[c(OUT_OF_BOUNDS, 2), , drop = TRUE])
    expect_error(TST_A[c(OUT_OF_BOUNDS, 2), , drop = FALSE])
    expect_error(TST_B[c(OUT_OF_BOUNDS, 2), , drop = FALSE])
    ...
    expect_error(TST_A[c(OUT_OF_BOUNDS, 2), c(OUT_OF_BOUNDS, 2)])
    expect_error(TST_B[c(OUT_OF_BOUNDS, 2), c(OUT_OF_BOUNDS, 2)])
    expect_error(TST_A[c(OUT_OF_BOUNDS, 2), c(OUT_OF_BOUNDS, 2), drop = TRUE])
    expect_error(TST_B[c(OUT_OF_BOUNDS, 2), c(OUT_OF_BOUNDS, 2), drop = TRUE])
    expect_error(TST_A[c(OUT_OF_BOUNDS, 2), c(OUT_OF_BOUNDS, 2), drop = FALSE])
    expect_error(TST_B[c(OUT_OF_BOUNDS, 2), c(OUT_OF_BOUNDS, 2), drop = FALSE])

    expect_error(TST_A[c(2, OUT_OF_BOUNDS), ])
    expect_error(TST_B[c(2, OUT_OF_BOUNDS), ])
    expect_error(TST_A[c(2, OUT_OF_BOUNDS), , drop = TRUE])
    expect_error(TST_B[c(2, OUT_OF_BOUNDS), , drop = TRUE])
    expect_error(TST_A[c(2, OUT_OF_BOUNDS), , drop = FALSE])
    expect_error(TST_B[c(2, OUT_OF_BOUNDS), , drop = FALSE])
    ...
    expect_error(TST_A[c(2, OUT_OF_BOUNDS), c(2, OUT_OF_BOUNDS)])
    expect_error(TST_B[c(2, OUT_OF_BOUNDS), c(2, OUT_OF_BOUNDS)])
    expect_error(TST_A[c(2, OUT_OF_BOUNDS), c(2, OUT_OF_BOUNDS), drop = TRUE])
    expect_error(TST_B[c(2, OUT_OF_BOUNDS), c(2, OUT_OF_BOUNDS), drop = TRUE])
...
test_that("multi indexing by negative integers works", {
    ...
    expect_equal(TST_A[c(-OUT_OF_BOUNDS), ], TST_B[c(-OUT_OF_BOUNDS), ])
    expect_equal(TST_A[c(-OUT_OF_BOUNDS), , drop = TRUE], TST_B[c(-OUT_OF_BOUNDS), , drop = TRUE])
    expect_equal(TST_A[c(-OUT_OF_BOUNDS), , drop = FALSE], TST_B[c(-OUT_OF_BOUNDS), , drop = FALSE])

    expect_equal(TST_A[, c(-OUT_OF_BOUNDS)], TST_B[, c(-OUT_OF_BOUNDS)])
    expect_equal(TST_A[, c(-OUT_OF_BOUNDS), drop = TRUE], TST_B[, c(-OUT_OF_BOUNDS), drop = TRUE])
    expect_equal(TST_A[, c(-OUT_OF_BOUNDS), drop = FALSE], TST_B[, c(-OUT_OF_BOUNDS), drop = FALSE])

    expect_equal(TST_A[c(-OUT_OF_BOUNDS), c(-OUT_OF_BOUNDS)], TST_B[c(-OUT_OF_BOUNDS), c(-OUT_OF_BOUNDS)])
    expect_equal(TST_A[c(-OUT_OF_BOUNDS), c(-OUT_OF_BOUNDS), drop = TRUE], TST_B[c(-OUT_OF_BOUNDS), c(-OUT_OF_BOUNDS), drop = TRUE])
    expect_equal(TST_A[c(-OUT_OF_BOUNDS), c(-OUT_OF_BOUNDS), drop = FALSE], TST_B[c(-OUT_OF_BOUNDS), c(-OUT_OF_BOUNDS), drop = FALSE])
    ...
    expect_equal(TST_A[c(-OUT_OF_BOUNDS, -2), c(-OUT_OF_BOUNDS, -2)], TST_B[c(-OUT_OF_BOUNDS, -2), c(-OUT_OF_BOUNDS, -2)])
    expect_equal(TST_A[c(-OUT_OF_BOUNDS, -2), c(-OUT_OF_BOUNDS, -2), drop = TRUE], TST_B[c(-OUT_OF_BOUNDS, -2), c(-OUT_OF_BOUNDS, -2), drop = TRUE])
    expect_equal(TST_A[c(-OUT_OF_BOUNDS, -2), c(-OUT_OF_BOUNDS, -2), drop = FALSE], TST_B[c(-OUT_OF_BOUNDS, -2), c(-OUT_OF_BOUNDS, -2), drop = FALSE])
    ...
    expect_equal(TST_A[c(-2, -OUT_OF_BOUNDS), c(-2, -OUT_OF_BOUNDS)], TST_B[c(-2, -OUT_OF_BOUNDS), c(-2, -OUT_OF_BOUNDS)])
...
test_that("multi indexing by logicals works", {
    ...
    expect_error(TST_A[c(rep_len(TRUE, OUT_OF_BOUNDS)), ])
    expect_error(TST_B[c(rep_len(TRUE, OUT_OF_BOUNDS)), ])
    expect_error(TST_A[c(rep_len(TRUE, OUT_OF_BOUNDS)), , drop = rep_len(TRUE, OUT_OF_BOUNDS)])
    expect_error(TST_B[c(rep_len(TRUE, OUT_OF_BOUNDS)), , drop = rep_len(TRUE, OUT_OF_BOUNDS)])
    expect_error(TST_A[c(rep_len(TRUE, OUT_OF_BOUNDS)), , drop = FALSE])
    expect_error(TST_B[c(rep_len(TRUE, OUT_OF_BOUNDS)), , drop = FALSE])
    ...
    expect_error(TST_A[c(rep_len(TRUE, OUT_OF_BOUNDS)), c(rep_len(TRUE, OUT_OF_BOUNDS))])
    expect_error(TST_B[c(rep_len(TRUE, OUT_OF_BOUNDS)), c(rep_len(TRUE, OUT_OF_BOUNDS))])
    expect_error(TST_A[c(rep_len(TRUE, OUT_OF_BOUNDS)), c(rep_len(TRUE, OUT_OF_BOUNDS)), drop = rep_len(TRUE, OUT_OF_BOUNDS)])
    expect_error(TST_B[c(rep_len(TRUE, OUT_OF_BOUNDS)), c(rep_len(TRUE, OUT_OF_BOUNDS)), drop = rep_len(TRUE, OUT_OF_BOUNDS)])
    expect_error(TST_A[c(rep_len(TRUE, OUT_OF_BOUNDS)), c(rep_len(TRUE, OUT_OF_BOUNDS)), drop = FALSE])
    expect_error(TST_B[c(rep_len(TRUE, OUT_OF_BOUNDS)), c(rep_len(TRUE, OUT_OF_BOUNDS)), drop = FALSE])
    ...
    expect_error(TST_A[c(rep_len(FALSE, OUT_OF_BOUNDS)), ])
    expect_error(TST_B[c(rep_len(FALSE, OUT_OF_BOUNDS)), ])
    expect_error(TST_A[c(rep_len(FALSE, OUT_OF_BOUNDS)), , drop = rep_len(FALSE, OUT_OF_BOUNDS)])
    expect_error(TST_B[c(rep_len(FALSE, OUT_OF_BOUNDS)), , drop = rep_len(FALSE, OUT_OF_BOUNDS)])
    expect_error(TST_A[c(rep_len(FALSE, OUT_OF_BOUNDS)), , drop = rep_len(FALSE, OUT_OF_BOUNDS)])
    expect_error(TST_B[c(rep_len(FALSE, OUT_OF_BOUNDS)), , drop = rep_len(FALSE, OUT_OF_BOUNDS)])
    ...
    expect_error(TST_A[c(rep_len(FALSE, OUT_OF_BOUNDS)), c(rep_len(FALSE, OUT_OF_BOUNDS))])
    expect_error(TST_B[c(rep_len(FALSE, OUT_OF_BOUNDS)), c(rep_len(FALSE, OUT_OF_BOUNDS))])
    expect_error(TST_A[c(rep_len(FALSE, OUT_OF_BOUNDS)), c(rep_len(FALSE, OUT_OF_BOUNDS)), drop = rep_len(FALSE, OUT_OF_BOUNDS)])
    expect_error(TST_B[c(rep_len(FALSE, OUT_OF_BOUNDS)), c(rep_len(FALSE, OUT_OF_BOUNDS)), drop = rep_len(FALSE, OUT_OF_BOUNDS)])
    expect_error(TST_A[c(rep_len(FALSE, OUT_OF_BOUNDS)), c(rep_len(FALSE, OUT_OF_BOUNDS)), drop = rep_len(FALSE, OUT_OF_BOUNDS)])
    expect_error(TST_B[c(rep_len(FALSE, OUT_OF_BOUNDS)), c(rep_len(FALSE, OUT_OF_BOUNDS)), drop = rep_len(FALSE, OUT_OF_BOUNDS)])
    ...
    expect_error(TST_A[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), ])
    expect_error(TST_B[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), ])
    expect_error(TST_A[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), , drop = TRUE])
    expect_error(TST_B[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), , drop = TRUE])
    expect_error(TST_A[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), , drop = FALSE])
    expect_error(TST_B[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), , drop = FALSE])
    ...
    expect_error(TST_A[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS)])
    expect_error(TST_B[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS)])
    expect_error(TST_A[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), drop = TRUE])
    expect_error(TST_B[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), drop = TRUE])
    expect_error(TST_A[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), drop = FALSE])
    expect_error(TST_B[rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), rep_len(c(TRUE, FALSE), OUT_OF_BOUNDS), drop = FALSE])
    ...
    expect_error(TST_A[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), ])
    expect_error(TST_B[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), ])
    expect_error(TST_A[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), , drop = TRUE])
    expect_error(TST_B[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), , drop = TRUE])
    expect_error(TST_A[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), , drop = FALSE])
    expect_error(TST_B[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), , drop = FALSE])
    ...
    expect_error(TST_A[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS)])
    expect_error(TST_B[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS)])
    expect_error(TST_A[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), drop = TRUE])
    expect_error(TST_B[rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), rep_len(c(FALSE, TRUE), OUT_OF_BOUNDS), drop = TRUE])
