...
expect_true(nrow(CROCHET_EXTRACT_ENV$CUSTOM_OBJECT) > 3)
expect_true(ncol(CROCHET_EXTRACT_ENV$CUSTOM_OBJECT) > 3)
expect_true(length(CROCHET_EXTRACT_ENV$CUSTOM_OBJECT) > 3)

# maximum dimension requirement are met
expect_true(nrow(CROCHET_EXTRACT_ENV$CUSTOM_OBJECT) < CROCHET_EXTRACT_ENV$OUT_OF_BOUNDS_INT)
expect_true(ncol(CROCHET_EXTRACT_ENV$CUSTOM_OBJECT) < CROCHET_EXTRACT_ENV$OUT_OF_BOUNDS_INT)
expect_true(length(CROCHET_EXTRACT_ENV$CUSTOM_OBJECT) < CROCHET_EXTRACT_ENV$OUT_OF_BOUNDS_INT)
